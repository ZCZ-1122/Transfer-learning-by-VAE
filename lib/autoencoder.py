...
from cs230.decoder import Decoder1d, Decoder2d
from cs230.encoder import Encoder1d, Encoder2d
from cs230.layers import reparameterize
...
def sample(model, num_samples, latent_dim, device, seed=None):
    # Set seed for the sake of comparison
    if seed is not None:
        print('seed set')
